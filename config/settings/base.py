...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://postgres:admin123@localhost:5432/nomadgram'),
}
...
STATICFILES_DIRS = [
    ...
    str(ROOT_DIR.path('fronted', 'build', 'static'))
]
